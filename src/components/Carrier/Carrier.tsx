...
const Carrier = ({operator}: Props) => {
  ...
  switch (operator.id) {
    ...
    case "glaser":
      return (
        <div sx={{ gridColumn: ["21 / span 4", "21 / span 4","25 / span 2"] }} title={operator.name}>
          <img src={Glaser} alt={operator.name} sx={ styles } /> 
        </div>
      )
    ...
    case "lange":
      return (
        <div sx={{ gridColumn: ["21 / span 4", "21 / span 4","25 / span 2"] }} title={operator.name}>
          <img src={Lange} alt={operator.name} sx={ styles } /> 
        </div>
      )
    ...
    case "uckermarkische-verkehrsgesellschaft-mbh":
      return (
        <div sx={{ gridColumn: ["21 / span 4", "21 / span 4","25 / span 2"] }} title={operator.name}>
