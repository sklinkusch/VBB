...
import { getBlankenburg, getBornholmerStr, getBuch, getKarow, getPankow, getPankowHeinersdorf, getPrenzlauerAllee, getSchönhauserAllee, getWollankstr } from "./Pankow"
