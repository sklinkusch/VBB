	...
	if (mode === "arr" && provenance !== null) {
		switch (lineName) {
			...
			case "163":
				...
				return ["S Adlershof [Bus Rudower Chaussee]", 1]
			case "164":
				if (provenance.includes("Köpenick"))
					return ["S Adlershof [Bus Rudower Chaussee]", 1]
				return ["S Adlershof [Bus Rudower Chaussee]", 7]
			case "260":
		...
		switch (lineName) {
			...
			case "61":
				...
				return ["S Adlershof [Tram Rudower Chaussee]", 3]
			case "63":
				if (direction.includes("Johannisthal"))
					return ["S Adlershof [Tram Rudower Chaussee]", 2]
				return ["S Adlershof [Tram Rudower Chaussee]", 3]
			case "162":
			...
			case "163":
				...
				return ["S Adlershof [Bus Rudower Chaussee]", 7]
			case "164":
				if (direction.includes("Köpenick"))
					return ["S Adlershof [Bus Rudower Chaussee]", 7]
				return ["S Adlershof [Bus Rudower Chaussee]", 1]
			case "260":
				return ["S Adlershof [Bus Rudower Chaussee]", 1]
...
export function getAltglienicke(id: string) {
	switch (id) {
		case "900000195510":
			return "S Altglienicke [Bus Ewaldstr.]"
		case "900000196514":
			return "Johannes-Tobei-Str."
	}
}
...
export function getGrünau(
	...
	if (mode === "arr" && provenance !== null) {
		switch (lineName) {
			case "68":
				if (provenance.includes("Schmöckwitz"))
			...
			case "N62":
				if (provenance.includes("Wendenschloß"))
		...
		switch (lineName) {
			case "68":
				if (direction.includes("Schmöckwitz"))
					return ["S Grünau [Adlergestell]", 9]
				return ["S Grünau [Adlergestell]", 8]
			case "163":
			case "263":
			case "363":
				return ["S Grünau [Richterstr.]", 1]
			case "N62":
				if (direction.includes("Wendenschloß"))
					return ["S Grünau [Richterstr.]", 1]
				return ["S Grünau [Richterstr.]", 5]
			case "N68":
				if (direction.includes("Schmöckwitz"))
		...
		switch (id) {
			case "900000180001":
				switch (lineName) {
					...
					case "X69":
					case "269":
						if (provenance.includes("Müggelschlößchenweg"))
							return ["S Köpenick [Bahnhofstr.]", 5]
						return ["S Köpenick [Mahlsdorfer Str.]", 1]
					case "164":
						if (provenance.includes("Kaulsdorfer Str."))
							return ["S Köpenick [Mahlsdorfer Str.]", 1]
						return ["S Köpenick [Bahnhofstr.]", 5]
					case "169":
					...
					case "N90":
						...
						return ["S Köpenick [Mahlsdorfer Str.]", 1]
					default:
						return ["S Köpenick [Tram Bus]", null]
				}
			case "900000180701":
		...
		switch (id) {
			case "900000180001":
				switch (lineName) {
					...
					case "X69":
					case "269":
						if (direction.includes("Müggelschlößchenweg"))
							return ["S Köpenick [Mahlsdorfer Str.]", 1]
						return ["S Köpenick [Bahnhofstr.]", 5]
					case "164":
						if (direction.includes("Kaulsdorfer Str."))
							return ["S Köpenick [Bahnhofstr.]", 5]
						return ["S Köpenick [Mahlsdorfer Str.]", 1]
					case "169":
	...
	if (mode === "arr" && provenance !== null) {
		switch (id) {
			case "900000190100":
				switch (lineName) {
					...
					case "165":
						...
						return ["Elsenstr./S Treptower Park [Bus Puschkinallee]", 2]
					case "166":
						if (provenance.includes("Weisestr"))
							return ["Elsenstr./S Treptower Park [Bus Puschkinallee]", 2]
						return ["Elsenstr./S Treptower Park [Bus Elsenstr.]", 1]
					case "194":
					case "N94":
			...
			case "900000190702":
				switch (lineName) {
					...
					case "194":
						if (provenance.includes("Friedrichsfelde Ost"))
							return ["S Treptower Park [Bus Treptowers]", 3]
						if (provenance.includes("Weigel"))
							return ["S Treptower Park [Bus Treptowers]", 3]
						return ["S Treptower Park [Bus Treptowers]", 4]
					case "N94":
		...
		switch (id) {
			case "900000190100":
				switch (lineName) {
					case "M43":
						if (direction.includes("Fahrt endet hier"))
							return ["Elsenstr./S Treptower Park [Bus Puschkinallee]", 2]
						return ["Elsenstr./S Treptower Park [Bus Elsenstr.]", 1]
					case "165":
						...
						return ["Elsenstr./S Treptower Park [Bus Elsenstr.]", 1]
					case "166":
						if (direction.includes("Boddinstr"))
							return ["Elsenstr./S Treptower Park [Bus Elsenstr.]", 3]
						return ["Elsenstr./S Treptower Park [Bus Puschkinallee]", 2]
					case "194":
					case "N94":
						return ["Elsenstr./S Treptower Park [Bus Elsenstr.]", 1]
			...
			case "900000190702":
				switch (lineName) {
					case "M43":
						...
						return ["S Treptower Park [Bus Treptowers]", 3]
					case "194":
						if (direction.includes("Friedrichsfelde Ost"))
							return ["S Treptower Park [Bus Treptowers]", 4]
						if (direction.includes("Weigel"))
							return ["S Treptower Park [Bus Treptowers]", 4]
						return ["S Treptower Park [Bus Treptowers]", 3]
					case "N94":
