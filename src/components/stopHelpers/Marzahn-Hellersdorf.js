export function getFriedrichsfeldeOst(lineName, direction) {
  switch(lineName) {
    case "M17":
    case "27":
    case "37":
...
export function getMahlsdorf(id, mode, lineName, direction, provenance) {
  if (mode === "arr") {
    switch(lineName) {
      case "62":
...
export function getMarzahn(product, lineName, direction) {
